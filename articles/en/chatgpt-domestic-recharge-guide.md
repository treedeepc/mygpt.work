...
Go is the lightest starting point. Plus is designed for regular study, writing, and office work. Pro 5x and Pro 20x serve progressively heavier professional use. Official benefits and model availability can change, so verify them on the [official ChatGPT pricing page](https://chatgpt.com/pricing/).
...
Visit [mygpt.work](https://mygpt.work/) to compare the current plans and prices.
